...
/** @class */
function () {
  function Model(attrs, sync, events) {
    this.attrs = attrs;
    this.sync = sync;
    this.events = events;
  }
  ...
  Object.defineProperty(Model.prototype, "trriger", {
    get: function get() {
...
function (_super) {
  ...
  User.buildUser = function (data) {
    return new User(new Attributes_1.Attributes(data), new ApiSync_1.ApiSync(), new Eventing_1.Eventing());
  };
...
console.log(user.getAll); // user.sync.save({ name: 'save NewThing', age: 32 });
